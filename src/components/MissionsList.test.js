...
// Steps to getting data from the API call:
// Open devtools and navigate to the Network tab
// Clear history and run whatever action instigates the API call
// Click on the API call from the list and go to the Response tab
// highlight all the code, and copy it onto the clipboard
// Paste code into your editor and save the file
// If the code doesn’t format into as JS object, go to https://json-to-js.com/
// Paste your JSON into the left input, and it will convert it to JS
// Click Copy result to clipboard then paste into your editor
